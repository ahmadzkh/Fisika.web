...
{{-- <div class="row wrapperd-flex justify-content-around">
                <div class="col-lg-2 col-sm-12"> --}}
{{-- <nav id="sidebar" class="sidebar position-fixed">
                        <!-- <div class="ustom-menu">
...
<ul class="list-unstyled components mb-5">
     ...
     <li>
          <a href="#judul3" style="font-size: 16px;"><i class="fa-solid fa-square-root-variable mr-3"></i> Pengukuran dan Rumus</a>
     </li>
     <li>
